/* ════════════════════════════════════════════════════════════════
   ...
   · **какие оценки получил** — по каждой работе своя, с отзывом
...
/** Оценка — десятибалльная: так сказал владелец, и та же шкала на сервере (`ratings.js`). */
...
export const WORK_STATUSES = [
  { id: "ready", name: "на рабочем месте", free: true },
