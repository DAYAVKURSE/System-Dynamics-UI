...
describe("кто с кем совпал", () => {
  it("совпадение считается только когда назначены оба", () => {
    ...
    /* Не названо ни одного человека — и постановщик, и исполнитель это
       должность, названная функцией: передавать работу некому (владелец,
       2026-09-19). Поставленной такая задача становится, только если
       должность у функции и правда есть (`taskGaps`). */
    expect(selfSet(task({ setter: null, assignee: null }))).toBe(true);
