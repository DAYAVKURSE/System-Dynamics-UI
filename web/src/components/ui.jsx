...
/* ─────── ЗНАК ЗАДАЧИ ───────
   ...
   названия на форме постановки задачи: куб в изометрии, внутри — дерево
   связей с точками на концах ветвей.

   Рисуется, а не кладётся картинкой: у исходника чёрный фон, который на
   форме был бы виден квадратом, а мелкая растровая картинка мылится. */
...
/* Ветви: по паре на боковые грани и пара на верхнюю — как на присланном знаке. */
const TWIGS = [
...
const BUDS = [[24, 11.6], [17.6, 14.8], [30.4, 14.8], [11.4, 25.2], [36.6, 25.2],
  [16.8, 31.6], [31.2, 31.6]];
export function CubeMark({ size = 22, color = BRAND, label = "знак" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" aria-label={label} role="img"
      style={{ display: "block", flex: "0 0 auto",
