...
Задача в приложении и есть одно выполнение функции. Подробности и инварианты
— в [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md), разбор каждого изменения
— в [`docs/CHANGELOG.md`](docs/CHANGELOG.md).
